...
const LocationCard: React.FC<ILocationCard> = ({id, name, dimension, type}) => {
    return (
        <Link to={`/locations/${id}`} className="w-full max-w-[600px] flex flex-col items-center text-center bg-[#3c3e44] rounded-xl overflow-hidden gap-4 shadow-md animate-slideup p-4">
            <div>
